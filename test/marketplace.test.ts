    ...
    : describe("Marketplace", () => {
          ...
          describe("Listing a NFT", () => {
              ...
              it("Reverts if the Marketpalce is not authorized to handle this NFT", async () => {
                  ...
                  ).to.be.revertedWithCustomError(marketplace, "Marketplace__NftUnAuthorized");
              });
              ...
              it("Won't list NFTs with zero price", async () => {
                  ...
                  ).to.be.revertedWithCustomError(marketplace, "Marketplace__PriceMustBeAboveZero");
              });
              ...
              describe("buy NFT ", () => {
                  ...
                  it("Reverts if the buying NFT is not listed on the marketplace", async () => {
                      ...
                      ).to.be.revertedWithCustomError(marketplace, "Marketplace__NftUnlisted");
                  });
                  ...
                  it("Increments the owner sales, unlists and changes of ownership", async () => {
                      const [nftPrice, owner] = await marketplace.getNft(nftAddress, tokenId);
                      const initialOwnerSales = await marketplace.balanceOf(owner);
                      await marketplace.connect(buyer).buyNft(nftAddress, 1, { value: nftPrice });
          ...
          describe("Withdraw Sales", () => {
              it("Revers if there is no funds to withdraw", async () => {
                  await expect(marketplace.withdrawBalance()).to.be.revertedWithCustomError(
                      marketplace,
